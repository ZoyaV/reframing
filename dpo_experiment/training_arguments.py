...
class ProcessingArguments:
    path_to_source: Optional[str] = field(default='../ppo_tuning/dataset/modified_output_concatenated_long_with_bboxes.csv',\
                                           metadata={"help": "path to csv with descriptions, img refs and GT bboxes"})
    
    path_to_imgs: Optional[str] = field(default='../ppo_tuning/dataset/gold/images/RGB_raw/',\
